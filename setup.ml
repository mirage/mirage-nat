...
(* OASIS_START *)
(* DO NOT EDIT (digest: ea1532f8c95418d9be1e9ead0036b456) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Nat_lookup"; "Nat_rewrite"; "Nat_translations"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Nat_decompose"; "Nat_shims"; "Nat_table"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "x\012\209\232\191Yf\217k\b\149\174\0045a\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
