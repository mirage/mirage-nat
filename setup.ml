...
(* OASIS_START *)
(* DO NOT EDIT (digest: 53bb57d06708a47f178e133a3463a7c0) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_nat"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Nat_rewrite"; "Nat_decompose"; "Nat_translations"];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-nat-hashtable";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_table"];
                      lib_pack = false;
                      lib_internal_modules = ["Nat_shims"; "Nat_table"];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\003oa\140s\155\136\209\183\222\250\166\248\187\250w";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
