...
(* OASIS_START *)
(* DO NOT EDIT (digest: 078e829472a58491132bb02d0ed9b788) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_nat"; "Nat_shims"; "Nat_packet"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_rewrite.ml"});
               Test
                 ({
                     cs_name = "test_rewrite";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "0\130=\200\169i\214\253*\186E:\146\242\205^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
