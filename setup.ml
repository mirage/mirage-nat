...
(* OASIS_START *)
(* DO NOT EDIT (digest: cbbcfc37733d1e92b5b10d6817d2e170) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-nat-irmin";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\194Q\r\142\030\233\203\131\231GR\136\249\243.\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
