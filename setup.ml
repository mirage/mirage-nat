...
(* OASIS_START *)
(* DO NOT EDIT (digest: dc20acc7510654509718aef98e156b50) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_nat"; "Nat_packet"];
                      lib_pack = false;
                      lib_internal_modules = ["Nat_rewrite"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\253\158\164\161\195K:\147b\130\192\236\021\204F+";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
