...
(* OASIS_START *)
(* DO NOT EDIT (digest: 890b62aa0c1ca127b36c18ea0d29bb62) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_lookup",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_lookup", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_rewrite",
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_lookup.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\146\004\139W\141L\220.\204@s\211\215\209:\133";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
