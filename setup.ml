...
(* OASIS_START *)
(* DO NOT EDIT (digest: ad3c1b0428d145c03d61484ed291a9c9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("tcpip.ethif", None);
                           FindlibPackage ("tcpip.arpv4", None);
                           FindlibPackage ("tcpip.ipv4", None);
                           FindlibPackage ("tcpip.ipv6", None);
                           FindlibPackage ("tcpip.icmpv4", None);
                           FindlibPackage ("tcpip.udp", None);
                           FindlibPackage ("tcpip.tcp", None);
                           ...
                           FindlibPackage ("mirage-time", None);
                           FindlibPackage ("mirage-clock", None)
                        ];
                   ...
                   {
                      lib_modules = ["Mirage_nat"; "Nat_shims"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Nat_rewrite"; "Nat_translations"; "Nat_decompose"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "Y\146\1895\190\"\237\209jp\156\182w\235u]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
