...
(** given a lookup table, default IP for new entries, rewrite direction, and an ip-level frame, 
...
val translate : Lookup.table -> Ipaddr.t -> direction -> Cstruct.t -> Cstruct.t option
